...
// Scored quiz for a weekly segment. Passing (≥60%) marks the segment mastered,
// awards XP, and advances the daily streak via lib/aws/progress.
export default function AwsQuiz({ segmentId, segmentTitle, questions }: AwsQuizProps) {
        ...
        {passed ? (
          ...
          >
            ...
            <p className="text-sm sm:text-base">
              You passed <strong>{segmentTitle}</strong>. XP awarded and the next week is unlocked!
            </p>
          </div>
        ) : (
          <p className="max-w-md text-sm sm:text-base">
            Not quite mastered — you need at least 60%. Review the objectives and services above and try again!
          </p>
        )}
        <button
          type="button"
